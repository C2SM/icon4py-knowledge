...
- [[personal/jcanton/model-state/model-state|Model state — requirements and design options]] — keywords: state, model-state, components, fields, registry, metadata, duplication, allocation, lazy-evaluation, labels, halo-exchange, prior-art
