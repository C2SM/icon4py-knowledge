...
- [[personal/jcanton/model-state/model-state|Model state]] — keywords: state, model-state, components, fields, registry, metadata, duplication, allocation, lazy-evaluation, labels, halo-exchange, restart, icon-sc, contracts, prior-art, constraints, goals
