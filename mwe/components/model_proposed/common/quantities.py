...
type VnField = Annotated[fa.EdgeKField[ta.wpfloat], quantity("normal_wind", units="m s-1", cf_key="vn")]
...
type ExnerField = Annotated[fa.CellKField[ta.wpfloat], quantity("exner_function", units="1", cf_key="exner")]
type ThetaVField = Annotated[fa.CellKField[ta.wpfloat], quantity("virtual_potential_temperature", units="K", cf_key="theta_v")]
type QvField = Annotated[fa.CellKField[ta.wpfloat], quantity("specific_humidity", units="kg kg-1", cf_key="qv")]
type MassFluxField = Annotated[fa.EdgeKField[ta.wpfloat], quantity("mass_flux_at_edges", units="kg m-2 s-1")]
type TemperatureField = Annotated[fa.CellKField[ta.wpfloat], quantity("air_temperature", units="K", cf_key="ta")]
type UField = Annotated[fa.CellKField[ta.wpfloat], quantity("eastward_wind", units="m s-1", cf_key="ua")]
type PrecipField = Annotated[fa.CellField[ta.wpfloat], quantity("precipitation_flux", units="kg m-2 s-1", cf_key="pr")]
